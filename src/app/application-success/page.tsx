    ...
    <div className="flex min-h-screen flex-col bg-secondary/50 items-center justify-center p-4 text-center">
        ...
        <div className="max-w-md">
            ...
            <p className="mt-4 text-muted-foreground md:text-lg">
                Thank you for submitting your loan application. Our team will review your information and get back to you within 3-5 business days.
            </p>
            {applicationId && <p className="mt-2 text-muted-foreground text-sm">Your application ID is: {applicationId}</p>}
